!function (root) {
  ...
  function loadCss(e, t) {
    ...
    n.rel = 'stylesheet',
    n.href = e,
    'msie' === browser ? n.onreadystatechange = function () {
  ...
  function globalEval(code) {
    ...
    code && (1 === code.indexOf('use strict') ? (script = document.createElement('script'), script.text = code, head.appendChild(script).parentNode.removeChild(script))  : eval(code))
  }
  ...
  function ajax(e, t, n) {
    ...
    a.open(n ? 'POST' : 'GET', e + '&t=' + ~~(1000000 * Math.random()), !0),
...
function (e) {
  ...
  function n(e, t) {
    for (var n, a = 0, r = e.length; r > a; a++) n = e[a],
    t.call(n, n, a)
  }
  function a(e, t) {
  ...
  a = function () {
    function e(e, n) {
      ...
      r = function () {
        ...
        if (e.styles && e.styles.length) for (a = 0, r = e.styles.length; r > a; a++) o = t.appendStyle(e.styles[a]),
        s.push(o);
        i = e.container && 'string' == typeof e.container ? document.getElementById(e.container)  : e.container || document.getElementById(e.id),
        i.innerHTML = e.html,
      ...
      o = function (n) {
        ...
        o = function () {
          var a,
          r;
          if (e.scripts && e.scripts.length) for (a = 0, r = e.scripts.length; r > a; a++) t.globalEval(e.scripts[a]);
          n && n(e)
        };
    ...
    return {
      onPageletArrive: function (t) {
        ...
        var r = e(t, function () {
          var e;
          if (!--n) for (; e = o.shift(); ) a.trigger('pageletinsert', r, t),
          e.loadJs(function () {
      ...
      load: function (e) {
        ...
        for (e instanceof Array ? n = {
         ...
         : e, e = n.pagelets || n.pagelet, 'string' == typeof e && (e = e.split(/\s*,\s*/))), s = e.length, i = s - 1; i >= 0; i--) o = e[i],
        f.push('pagelets[]=' + o),
        p = n.container && n.container[o] || n.container,
        p && a.once('pageletarrive', function (e) {
          e.container = p
        });
        u = n.param ? '&' + n.param : '',
        l = location.search,
        l = l ? l + '&' : '?',
        d = (n.url || '') + l + f.join('&') + u,
        c = n.cb && a.on('pageletdone', function () {
  ...
  i = function () {
    ...
    function t(e) {
      ...
      if ('string' == typeof e) t = [
       ...
       else if ('[object Array]' === Object.prototype.toString.call(e)) for (var r = 0; r < e.length; r++) n[e[r]] !== a && t.push(e[r]);
...
!function (r) {
  ...
  require = function (r) {
    ...
    var i = 'function' == typeof n ? n.apply(e, [
      require,
      e.exports,
      e
    ])  : n;
...
JKXY = {
  ...
  gotop: function () {
    ...
    //   var t = $.cookie('pewm');
    //   'none' == t && $('.erwma').show(),
    //   'none' != t && $('#bannerbox').length > 0 && e('#pewm')
    // });
    // if (0 == $('#gototop').length) {
    //   $('body').append(n);
    //   var n = $('#gototop');
    //   t()
    // } else var n = $('#gototop');
    // $('.pewm1').find('.close').off(),
    // $('.pewm2').find('.close').off(),
    // $('.pewm3').find('.close').off(),
    // $('.pewm1').find('.close').on('click', function () {
    //   $('.pewm1').fadeOut().remove()
    // }),
    // $('.pewm2').find('.close').on('click', function () {
    //   $('.pewm2').fadeOut().remove(),
    //   sa.track('ad_all_right', {
    //     pageUrl: location.href,
    //     referrerUrl: document.referrer,
    //     // fromUrl: $.cookie('channel') || '',
    //     name: '关闭广告1'
    //   })
    // }),
    ...
    // n.find('.top').bind('click', function () {
